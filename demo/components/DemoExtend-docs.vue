...
Vue.customElement('demo-extend', DemoElement);
        </code></pre>
      </el-collapse-item>
    </el-collapse>
  </div>
...
<script>
  import Vue from 'vue';
  import DemoElement from 'demo/components/DemoExtend-component';
...
`export default {
    ...
    methods: {
      registerCustomElement() {
        Vue.customElement('demo-extend', DemoElement, { props: ['prop1', 'prop2'] });
      }
    }
